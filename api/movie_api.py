...
class Movie:
    ...
    def get_movie_5_cai(self, movie_id):
        ...
        # 设置10分钟缓存不变
        set_readis("movie_tag_cai" + "_" + str(movie_id) + "_" + str(5), movie_cai_rs_json, set_time=30 * 1)
    ...
    def get_user_movie_5_cai(self, user_id):
        ...
        # 设置10分钟缓存不变
        set_readis("user_tag_cai" + "_" + str(user_id) + "_" + str(5), user_movie_tag_cai_rs_json, set_time=30 * 1)
